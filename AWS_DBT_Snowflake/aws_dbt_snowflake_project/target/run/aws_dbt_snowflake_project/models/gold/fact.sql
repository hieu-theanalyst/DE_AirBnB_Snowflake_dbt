...
FROM
        ...
        LEFT JOIN AIRBNB.GOLD.DIM_LISTINGS AS DIM_listings ON GOLD_obt.LISTING_ID = DIM_listings.LISTING_ID
    
    
    
        LEFT JOIN AIRBNB.GOLD.DIM_HOSTS AS DIM_hosts ON GOLD_obt.HOST_ID = DIM_hosts.HOST_ID
